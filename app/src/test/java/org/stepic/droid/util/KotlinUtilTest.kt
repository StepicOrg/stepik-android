...
class KotlinUtilTest {
    ...
    fun testFormatPi2Digit() {
        ...
        assertEquals("3" + delimiter + "14", KotlinUtil.getNiceFormatOfDouble(pi))
    }

    @Test
    fun testFormatPiLeadZeros() {
        val pi = 3.00159265358979323
        assertEquals("3", KotlinUtil.getNiceFormatOfDouble(pi))
    }

    @Test
    fun testFormatPiLeadZerosRound() {
        val pi = 3.00959265358979323
        assertEquals("3" + delimiter + "01", KotlinUtil.getNiceFormatOfDouble(pi))
    }
    ...
    fun testFormatBigNumber() {
        ...
        assertEquals("123456789123456" + delimiter + "11", KotlinUtil.getNiceFormatOfDouble(big))
    }
