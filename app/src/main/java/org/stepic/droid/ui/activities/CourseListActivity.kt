...
class CourseListActivity : SingleFragmentActivity() {
    override fun createFragment(): Fragment {
        ...
        return when {
            info.courseListType == DbStructureCourseList.Type.ENROLLED -> MyCoursesFragment.newInstance()
            info.courseListType == DbStructureCourseList.Type.FEATURED -> PopularCoursesFragment.newInstance()
