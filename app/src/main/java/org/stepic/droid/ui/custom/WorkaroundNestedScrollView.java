...
/**
 * fix for support version of Nested Scroll view
 * Fix of this issue:
 * https://issuetracker.google.com/issues/37070828
 * <p>
 * https://issuetracker.google.com/issues/37070828#comment9 is not worked on 26.1.0 (API M)
 * <p>
 * Used Workaround:
 * https://stackoverflow.com/a/32783524/5222184
 */
public class WorkaroundNestedScrollView  extends FrameLayout implements NestedScrollingParent,
     ...
     *
     * @see #setOnScrollChangeListener(WorkaroundNestedScrollView.OnScrollChangeListener)
     */
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(WorkaroundNestedScrollView v, int scrollX, int scrollY,
    ...
    private WorkaroundNestedScrollView.SavedState mSavedState;

    private static final WorkaroundNestedScrollView.AccessibilityDelegate ACCESSIBILITY_DELEGATE = new WorkaroundNestedScrollView.AccessibilityDelegate();
    ...
    private WorkaroundNestedScrollView.OnScrollChangeListener mOnScrollChangeListener;
    ...
    public WorkaroundNestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setOnScrollChangeListener(WorkaroundNestedScrollView.OnScrollChangeListener l) {
...
//                mIsBeingDragged = !mScroller.isFinished();
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (!(state instanceof WorkaroundNestedScrollView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }

        WorkaroundNestedScrollView.SavedState ss = (WorkaroundNestedScrollView.SavedState) state;
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        WorkaroundNestedScrollView.SavedState ss = new WorkaroundNestedScrollView.SavedState(superState);
    ...
    static class SavedState extends BaseSavedState {
        ...
        public static final Parcelable.Creator<WorkaroundNestedScrollView.SavedState> CREATOR =
                new Parcelable.Creator<WorkaroundNestedScrollView.SavedState>() {
                    @Override
                    public WorkaroundNestedScrollView.SavedState createFromParcel(Parcel in) {
                        return new WorkaroundNestedScrollView.SavedState(in);
                    }

                    @Override
                    public WorkaroundNestedScrollView.SavedState[] newArray(int size) {
                        return new WorkaroundNestedScrollView.SavedState[size];
                    }
                };
    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final WorkaroundNestedScrollView nsvHost = (WorkaroundNestedScrollView) host;
