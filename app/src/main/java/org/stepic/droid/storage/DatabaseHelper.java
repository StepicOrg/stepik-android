...
import org.stepic.droid.storage.migration.MigrationFrom59To60;
...
//            update from 1 to 2
    ...
    private void upgradeFrom59To60(SQLiteDatabase db) {
        MigrationFrom59To60.INSTANCE.migrate(db);
    }
