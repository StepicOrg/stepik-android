...
import org.stepik.android.view.injection.achievements.AchievementsDataModule
...
@Module(includes = [AuthModule::class, SerializationModule::class, AchievementsDataModule::class])
