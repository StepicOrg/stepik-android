...
class SqlStepQuizFragment : Fragment(), StepQuizView {
    companion object {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? =
        (inflater.inflate(R.layout.fragment_step_quiz, container, false) as ViewGroup)
            .apply {
                addView(inflater.inflate(R.layout.layout_step_quiz_sql, this, false))
            }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sqlStepQuizFormDelegate = SqlStepQuizFormDelegate(view, stepWrapper)

        stepQuizDelegate =
            StepQuizDelegate(
                step = stepWrapper.step,
                lessonData = lessonData,
                stepQuizFormDelegate = sqlStepQuizFormDelegate,
