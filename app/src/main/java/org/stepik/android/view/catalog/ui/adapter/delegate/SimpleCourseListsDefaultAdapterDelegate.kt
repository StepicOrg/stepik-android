...
import org.stepic.droid.databinding.ItemBlockSimpleCourseListsDefaultBinding
...
class SimpleCourseListsDefaultAdapterDelegate(
    ...
    private inner class ViewHolder(root: android.view.View) : DelegateViewHolder<CatalogItem>(root) {
        private val viewBinding: ItemBlockSimpleCourseListsDefaultBinding by viewBinding { ItemBlockSimpleCourseListsDefaultBinding.bind(root) }
        ...
        init {
            ...
            snapHelper.attachToRecyclerView(viewBinding.courseListsRecycler)
        }
