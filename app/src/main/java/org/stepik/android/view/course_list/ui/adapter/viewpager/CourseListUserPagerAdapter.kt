...
class CourseListUserPagerAdapter(
    ...
    private val fragments = listOf(
        { CourseListUserFragment.newInstance(CourseListUserType.ALL) } to context.getString(R.string.course_list_user_all_courses_tab),
        { CourseListUserFragment.newInstance(CourseListUserType.FAVORITE) } to context.getString(R.string.course_list_user_favorites_tab),
        { CourseListUserFragment.newInstance(CourseListUserType.ARCHIVED) } to context.getString(R.string.course_list_user_archive_tab)
    )
