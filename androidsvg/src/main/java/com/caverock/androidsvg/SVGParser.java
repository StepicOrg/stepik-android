    ...
    */
    ...
    protected static class TextScanner {
       ...
       */
        ...
        /**
         * if includeWhitespacesInCenter = true, then token will with whitespaces, it is useful for font-family attribute in styles.
         */
        public String nextToken(char terminator, boolean includeWhitespacesInCenter) {
            if (empty())
                return null;
            ...
            int start = position;
            ch = advanceChar();
            while (ch != -1 && ch != terminator && (includeWhitespacesInCenter || !isWhitespace(ch))) {
                ch = advanceChar();
            }
